...
<Tip>
To convert the models you trained yourself into the `.dxnn` format, or to compile the models in the model
repository from source with the `dxmz` tool, you can review the
