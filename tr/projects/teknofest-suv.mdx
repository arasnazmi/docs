...
### <Icon icon="submarine" /> ArduPilot ile Su Altı Araç Kontrolü
...
### <Icon icon="microchip-ai" /> Edge AI ile Su Altı Nesne Tespiti
...
### <Icon icon="camera" /> MIPI CSI Kamera ile Su Altı Görüntüleme
...
### <Icon icon="wave-square" /> PWM ile Thruster Kontrolü
...
### <Icon icon="network-wired" /> CAN Bus ile ESC Haberleşmesi
...
### <Icon icon="compass" /> IMU ile Araç Yönelim ve Denge Kontrolü
...
### <Icon icon="clock" /> Gerçek Zamanlı Görev İcrası
...
### <Icon icon="wifi" /> Yer İstasyonu Bağlantısı
...
<CardGroup cols={2}>
  ...
  <Card title="ArduPilot" icon="submarine" href="/tr/projects/ardupilot">
