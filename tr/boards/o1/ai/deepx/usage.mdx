...
<Tip>
Kendi eğittiğiniz modelleri `.dxnn` biçimine dönüştürmek veya model deposundaki modelleri `dxmz` aracı ile
kaynağından derlemek için [Model Derleme](/tr/boards/o1/ai/deepx/models) bölümünü inceleyebilirsiniz.
</Tip>
